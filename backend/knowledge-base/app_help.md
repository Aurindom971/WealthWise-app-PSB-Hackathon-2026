# Secure Wealth - App Help & Feature Documentation

This document provides user-facing documentation, support articles, and feature explanations for the Secure Wealth application, including the SAGE AI assistant interface, portfolio tracking tools, and security features.
...
Secure Wealth's Spending Analytics tab automatically categorizes your debits into buckets like Food, Utilities, Investments, Shopping, and Travel. The system uses merchant category codes (MCCs) to group transactions and displays them in charts. You can use this dashboard to set category budgets, view month-on-month changes, and identify areas to optimize your spending.
