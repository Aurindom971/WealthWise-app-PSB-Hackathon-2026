                    ...
                    SizedBox(
                      ...
                      child: Scrollbar(
                        ...
                        child: SingleChildScrollView(
                          controller: _contactsScrollController,
                          child: Column(
                            children: _mockContacts.map((contact) {
                              final isSelected =
                        ...
                        child: MobileScanner(
                          onDetect: (capture) {
                            ...
                            if (barcodes.isNotEmpty &&
                              ...
                              _isScanned = true;
                              if (!mounted) return;
                              // Automatically return the scanned UPI ID
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            if (recipientName != null && amount != null && amount.isNotEmpty)
              Container(
                width: double.infinity,
                padding: const EdgeInsets.symmetric(
                  vertical: 16,
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      !_isBalanceUnlocked
                          ? "Check Balance"
                          : "Check Balance: ${_isBalanceVisible ? '₹1,45,000.50' : '******'}",
                      style: const TextStyle(
                        color: kForest,
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [kForest, kMid], // Vibrant green to lime
              begin: Alignment.centerLeft,
              end: Alignment.centerRight,
            ),
          ),
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [kAccent.withValues(alpha: 0.05), Colors.white],
            begin: Alignment.topCenter,
            end: Alignment.bottomCenter,
          ),
        ),
